...
class CalendarMonthNoSpaceAdapter(
    var onSwipeListener: OnSwipeListener,
    val clickListener: (Int, Int) -> Unit,
) : RecyclerView.Adapter<CalendarMonthNoSpaceAdapter.MonthView>() {
    ...
    override fun onBindViewHolder(holder: MonthView, position: Int) {
        ...
        with(holder) {
            ...
            val dayListAdapter = CalendarDayNoSpaceAdapter(weekOfMonth, tempMonth, dayList) { month, day ->
